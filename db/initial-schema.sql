...
-- code = out_trade_no
CREATE TABLE order (id INTEGER PRIMARY KEY, out_trade_no TEXT,user_id INTEGER, room_id INTEGER, price INTEGER, startTime DATETIME, endTime DATETIME,
  prepay_id INTEGER, ticket_id INTEGER, pay_status BOOLEAN, create_time DATETIME, modify_time DATETIME);
...
CREATE TABLE ticket_verify (id INTEGER PRIMARY KEY, ticket_id INTEGER, user_id INTEGER, transaction_id INTEGER,verify INTEGER(1),
  sendout BOOLEAN, create_time DATETIME, modify_time DATETIME);
---update
